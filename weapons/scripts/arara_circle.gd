...
func _ready() -> void:
	...
	descriptions= [
		"Aumenta o dano base das araras.",
		"Diminui o tempo entre voos de araras.",
		"Aumenta o dano base das araras.",
		"Aumenta a velocidade das araras.",
		"Aumenta o dano e diminui o tempo entre voos de araras."]
	weapon_name = "Arara"
